...
export class Car extends React.Component<ICarProps, ICarState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="car-heading">
          <Translate contentKey="carsApp.car.home.title">Cars</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="carsApp.car.home.createLabel">Create a new Car</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {carList && carList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('model')}>
                    <Translate contentKey="carsApp.car.model">Model</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th>
                    <Translate contentKey="carsApp.car.user">User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
                ...
                {carList.map((car, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {car.photo ? (
                        <div>
                          <a onClick={openFile(car.photoContentType, car.photo)}>
                            <img src={`data:${car.photoContentType};base64,${car.photo}`} style={{ maxHeight: '30px' }} />
                            &nbsp;
                          </a>
                          <span>
                            {car.photoContentType}, {byteSize(car.photo)}
                          </span>
                        </div>
                      ) : null}
                    </td>
                    <td>{car.user ? car.user.login : ''}</td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="carsApp.car.home.notFound">No Cars found</Translate>
            </div>
          )}
        </div>
